...
//不知道字段类型的情况下，也可以用rs.getObject(…)来打印输出结果
        ...
        sql = "insert into STUDENTS(NO,NAME,AGE,CLASS,IP) values(?,?,?,?,?)";
        stmt = con.prepareStatement(sql);
        stmt.setObject(1,"20191003149");
        stmt.setObject(2,"曾繁浩");
        stmt.setObject(3,22);
        stmt.setObject(4,"软工1904");
        stmt.setObject(5,"10.173.216.178");
        stmt.executeUpdate();
//查询是否插入数据成功
